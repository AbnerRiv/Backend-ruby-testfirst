...
describe "multiply" do
  ...
  it "computes the multiplication of two numbers" do
    expect(multiply(2, 3)).to eq(6)
  end

  it "computes the multiplicatation of more than 2 numbers" do
    expect(multiply(5, 5, 10)).to eq(250)
  end
  
end

describe "power" do
  it "computes 2 to the power of 3" do
